  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <Profile />
          <SidebarItem icon={Search} isSearched label="Search" onClick={search.onOpen} />
          <SidebarItem icon={PlusCircle} label="New Page" onClick={handleCreateDocument} />
        </div>
        <div className="mt-4">
          <DocumentList />
          <SidebarItem icon={Plus} label="Add a page" onClick={handleCreateDocument} />
          <Popover>
